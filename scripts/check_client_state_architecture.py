...
FORBIDDEN_CAMERA = (re.compile(r"^\s*(?:bool|int|float|vec2|ivec2|CCubicBezier)\s+m_[A-Za-z0-9_]+(?:\s*=[^;]+)?;\s*$"),)
...
FORBIDDEN_GAME_CLIENT_OWNER = (
	re.compile(r"\b(?:m_aLastUpdateTick|m_CharOrder|m_GameInfo|m_ServerMode|m_Teams)\b"),
