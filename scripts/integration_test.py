...
class TestRunner:
	...
	def skipped(self, test):
		return (test.requires_mastersrv and self.ddnet_mastersrv is None) or (test.requires_websockets and not self.test_websockets) or (test.requires_quic and not self.test_quic)
