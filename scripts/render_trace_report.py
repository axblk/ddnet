...
const frameMetrics=['commands','resource_commands','draw_commands','draw_calls','triangles','instances','render_passes','buffer_creates','buffer_recreates','texture_creates','texture_updates','upload_bytes','streamed_bytes','text_layout_ns','text_layout_calls','glyphs','text_creates','text_soft_recreates','text_deletes','text_renders','text_upload_bytes','frames_produced_delta','frames_rendered_delta','frames_dropped_delta','texture_memory','buffer_memory','streamed_memory','staging_memory'];
