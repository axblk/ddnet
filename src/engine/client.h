...
public:
	...
	virtual int OnSnapInput(CSessionId SessionId, int *pData, int Conn, bool Force) = 0;
	virtual void OnConnectionFocusChanged(CSessionId SessionId, int PreviousConn, int Conn) = 0;
