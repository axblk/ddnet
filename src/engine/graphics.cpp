...
void IGraphics::QuadsSetSubset(float TopLeftU, float TopLeftV, float BottomRightU, float BottomRightV)
{
	m_aTexture[0].u = TopLeftU;
	m_aTexture[1].u = BottomRightU;
	m_aTexture[0].v = TopLeftV;
	m_aTexture[1].v = TopLeftV;

	m_aTexture[3].u = TopLeftU;
	m_aTexture[2].u = BottomRightU;
	m_aTexture[3].v = BottomRightV;
	m_aTexture[2].v = BottomRightV;
}
