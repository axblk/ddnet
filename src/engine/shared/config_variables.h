...
MACRO_CONFIG_INT(ClConnectProtocol, cl_connect_protocol, 1, 0, 3, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Transport to prefer, falling back to the legacy one where the server does not announce it: 0 = legacy, 1 = QUIC, 2 = websocket, 3 = WebTransport")
MACRO_CONFIG_INT(ClConnectAddressFamily, cl_connect_address_family, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Address family to connect with: 0 = IPv4 only, 1 = IPv6 where the server has it and IPv4 where it does not")
