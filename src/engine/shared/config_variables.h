...
MACRO_CONFIG_STR(ClQuicCert, cl_quic_cert, 65, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "SHA-256 of the certificate QUIC servers must present, instead of what they announce")
MACRO_CONFIG_STR(ClQuicServerName, cl_quic_server_name, 128, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Name the certificate of QUIC servers is checked for, instead of what they announce")
...
#endif
MACRO_CONFIG_STR(SvTlsCert, sv_tls_cert, IO_MAX_PATH_LENGTH, "", CFGFLAG_SERVER, "PEM certificate chain or DER certificate for QUIC and WebTransport, checked with Web PKI when sv_register_hostname is set, a managed one if empty (restart required)")
...
MACRO_CONFIG_STR(SvRegisterHostname, sv_register_hostname, 256, "", CFGFLAG_SERVER, "Public DNS name of the server for QUIC and WebTransport, registered instead of the observed IP (restart required)")
