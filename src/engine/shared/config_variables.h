...
MACRO_CONFIG_INT(ClQuic, cl_quic, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Connect over QUIC to servers that offer it (0 to always use the legacy transport)")
MACRO_CONFIG_INT(ClConnectProtocol, cl_connect_protocol, 0, 0, 4, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Transport to connect with: 0 = what the server offers, 1 = legacy, 2 = QUIC, 3 = websocket, 4 = WebTransport")
MACRO_CONFIG_INT(ClConnectAddressFamily, cl_connect_address_family, 0, 0, 2, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Address family to connect with: 0 = both, preferring IPv6, 1 = IPv4, 2 = IPv6")
