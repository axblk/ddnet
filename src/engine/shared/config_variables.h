...
MACRO_CONFIG_INT(ClQuic, cl_quic, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Use the opt-in native QUIC transport for direct connections")
MACRO_CONFIG_INT(ClQuicAuto, cl_quic_auto, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Automatically prefer advertised shared-port QUIC with safe legacy fallback")
MACRO_CONFIG_INT(ClQuicFallbackDelayMs, cl_quic_fallback_delay_ms, 250, 0, 2000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Delay before preparing a legacy UDP fallback while automatic QUIC connects")
...
MACRO_CONFIG_STR(SvQuicCert, sv_quic_cert, IO_MAX_PATH_LENGTH, "", CFGFLAG_SERVER, "DER certificate for QUIC and WebTransport (restart required)")
MACRO_CONFIG_STR(SvQuicCertNext, sv_quic_cert_next, IO_MAX_PATH_LENGTH, "", CFGFLAG_SERVER, "Next DER certificate to advertise during QUIC and WebTransport certificate rotation (restart required)")
MACRO_CONFIG_STR(SvQuicKey, sv_quic_key, IO_MAX_PATH_LENGTH, "", CFGFLAG_SERVER | CFGFLAG_NONTEEHISTORIC, "PKCS#8 DER private key for QUIC and WebTransport (restart required)")
...
MACRO_CONFIG_INT(SvWebtransport, sv_webtransport, 0, 0, 1, CFGFLAG_SERVER, "Enable WebTransport on the server UDP port (restart required)")
MACRO_CONFIG_STR(SvWebtransportOrigin, sv_webtransport_origin, 256, "", CFGFLAG_SERVER, "Exact Origin accepted by WebTransport, empty accepts all origins (restart required)")
