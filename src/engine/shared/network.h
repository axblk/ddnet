...
public:
	...
	// carries: `identity-sha256=<hex>` pins the server's identity,
	// `cert-sha256=<hex>[,<hex>]` names the certificates a browser takes;
	// empty takes whatever the server shows. Without QUIC there is nothing
	// to expect.
