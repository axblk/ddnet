...
UUID(NETMSG_MATCH_REPORT_START, "sv-match-report-start@ddnet.org")
UUID(NETMSG_MATCH_REPORT_CHUNK, "sv-match-report-chunk@ddnet.org")
UUID(NETMSG_MATCH_REPORT_END, "sv-match-report-end@ddnet.org")
UUID(NETMSG_MATCH_REPORT_LOCAL_PARTICIPANT, "sv-match-report-local-participant@ddnet.org")
UUID(NETMSG_LIVE_STATS_REQUEST, "cl-live-stats-request@ddnet.org")
UUID(NETMSG_LIVE_STATS_START, "sv-live-stats-start@ddnet.org")
UUID(NETMSG_LIVE_STATS_CHUNK, "sv-live-stats-chunk@ddnet.org")
UUID(NETMSG_LIVE_STATS_END, "sv-live-stats-end@ddnet.org")
