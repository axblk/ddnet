...
void CStatboard::RenderGlobalStats(const CRenderContext &Context)
{
	...
	GameClient()->m_Menus.RenderBackdropRegion({x - 10.f, y - 10.f - LiveHeight, StatboardContentWidth, StatboardContentHeight + LiveHeight}, IGraphics::CORNER_ALL, 17.0f);
	RenderTools()->DrawRect(x - 10.f, y - 10.f - LiveHeight, StatboardContentWidth, StatboardContentHeight + LiveHeight, ColorRGBA(0.0f, 0.0f, 0.0f, 0.5f), IGraphics::CORNER_ALL, 17.0f);
	if(pLive != nullptr)
	{
		...
		RenderTools()->DrawRect(x, y - 16.0f, StatboardContentWidth - 20.0f, 1.0f, ColorRGBA(1.0f, 1.0f, 1.0f, 0.15f), IGraphics::CORNER_NONE, 0.0f);
	}
