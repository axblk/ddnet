...
bool CLaser::HitCharacter(vec2 From, vec2 To)
{
	...
	CCharacter *pHit;
	const bool DDNetPhysics = GameWorld()->m_Core.m_PhysicsRuleset == EPhysicsRuleset::DDNET;
...
void CLaser::DoBounce()
{
	...
	Res = GameWorld()->m_Core.m_PhysicsRuleset == EPhysicsRuleset::DDNET ? Collision()->IntersectLineTeleWeapon(m_Pos, To, &Coltile, &To, nullptr, GameWorld()->m_Core.m_OldTeleportWeapons) : Collision()->IntersectLine(m_Pos, To, &Coltile, &To);
