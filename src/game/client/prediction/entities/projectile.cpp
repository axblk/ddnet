...
void CProjectile::Tick()
{
	...
	const bool HitOthers = GameWorld()->m_Core.m_PhysicsRuleset != EPhysicsRuleset::DDNET || g_Config.m_SvHit;
	if(((pTargetChr && (pOwnerChar ? !pOwnerChar->GrenadeHitDisabled() : HitOthers || m_Owner == -1 || pTargetChr == pOwnerChar)) || Collide || GameLayerClipped(CurPos)) && !IsWeaponCollide)
	{
