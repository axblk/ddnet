...
protected:
	...
	virtual void RenderTiles(const ColorRGBA &Color, const CRenderLayerParams &Params);
	/**
...
protected:
	void RenderTiles(const ColorRGBA &Color, const CRenderLayerParams &Params) override;
