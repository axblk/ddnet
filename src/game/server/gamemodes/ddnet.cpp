...
static const CGameModeRegistration gs_DDNet({"ddnet", "DDraceNetwork", protocol7::GAMEFLAG_RACE, true}, NewGameController<CGameControllerDDNet>);
...
CTuningParams CGameControllerDDNet::DefaultTuning() const
{
