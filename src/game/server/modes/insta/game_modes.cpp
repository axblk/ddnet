...
bool RegisterInstagibGameModes(CGameModeRegistry &Registry)
{
	return Registry.Register(
		       {"insta.idm", "Instagib DM", "iDM", "TestiDM", EGameModeScoreKind::POINTS, 0},
	       ...
	       Registry.Register(
		       {"insta.itdm", "Instagib TDM", "iTDM", "TestiTDM", EGameModeScoreKind::POINTS, protocol7::GAMEFLAG_TEAMS},
	       ...
	       Registry.Register(
		       {"insta.ictf", "Instagib CTF", "iCTF", "TestiCTF", EGameModeScoreKind::POINTS, protocol7::GAMEFLAG_TEAMS | protocol7::GAMEFLAG_FLAGS},
	       ...
	       Registry.Register(
		       {"insta.gdm", "Grenade Instagib DM", "gDM", "TestgDM", EGameModeScoreKind::POINTS, 0},
	       ...
	       Registry.Register(
		       {"insta.gtdm", "Grenade Instagib TDM", "gTDM", "TestgTDM", EGameModeScoreKind::POINTS, protocol7::GAMEFLAG_TEAMS},
	       ...
	       Registry.Register(
		       {"insta.gctf", "Grenade Instagib CTF", "gCTF", "TestgCTF", EGameModeScoreKind::POINTS, protocol7::GAMEFLAG_TEAMS | protocol7::GAMEFLAG_FLAGS},
