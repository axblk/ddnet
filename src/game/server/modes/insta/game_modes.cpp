...
bool RegisterInstagibGameModes(CGameModeRegistry &Registry)
{
	return Registry.Register(
		       ...
		       [](CGameContext *pGameServer, const CGameModeInfo &Info) -> std::unique_ptr<IGameController> { return std::make_unique<CGameControllerInstagibDM>(pGameServer, Info); }) &&
	       Registry.Register(
		       ...
		       [](CGameContext *pGameServer, const CGameModeInfo &Info) -> std::unique_ptr<IGameController> { return std::make_unique<CGameControllerInstagibTDM>(pGameServer, Info); }) &&
	       Registry.Register(
		       ...
		       [](CGameContext *pGameServer, const CGameModeInfo &Info) -> std::unique_ptr<IGameController> { return std::make_unique<CGameControllerInstagibCTF>(pGameServer, Info); }) &&
	       Registry.Register(
		       {"insta.gdm", "Grenade Instagib DM", "gDM", "TestgDM", EGameModeScoreKind::POINTS, 0, GAME_MODE_PROTOCOL_SIX | GAME_MODE_PROTOCOL_SEVEN},
		       [](CGameContext *pGameServer, const CGameModeInfo &Info) -> std::unique_ptr<IGameController> { return std::make_unique<CGameControllerGrenadeDM>(pGameServer, Info); }) &&
	       Registry.Register(
		       ...
		       [](CGameContext *pGameServer, const CGameModeInfo &Info) -> std::unique_ptr<IGameController> { return std::make_unique<CGameControllerGrenadeTDM>(pGameServer, Info); }) &&
	       Registry.Register(
		       ...
		       [](CGameContext *pGameServer, const CGameModeInfo &Info) -> std::unique_ptr<IGameController> { return std::make_unique<CGameControllerGrenadeCTF>(pGameServer, Info); });
}
